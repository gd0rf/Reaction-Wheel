...
#ifndef TYPES_CUBE_COMPUTER_COMMON_3__H
#define TYPES_CUBE_COMPUTER_COMMON_3__H
...
/**
 * @brief Enumeration for TypesCubeComputerCommon3_PowerSelect
*/
typedef enum TypesCubeComputerCommon3_PowerSelectEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__POWER_OFF = 0,            /**< Off */
    TYPES_CUBE_COMPUTER_COMMON_3__POWER_ON = 1,             /**< On */
    TYPES_CUBE_COMPUTER_COMMON_3__POWER_NO_CHANGE = 2,      /**< NoChange */
    TYPES_CUBE_COMPUTER_COMMON_3__POWER_AUTO = 3,           /**< Auto */
    TYPES_CUBE_COMPUTER_COMMON_3__POWER_ON_PASS = 4,        /**< On - Passthrough Only (No ADCS operations) */
    TYPES_CUBE_COMPUTER_COMMON_3__POWER_OFF_UPGRADE = 5,    /**< Power off for upgrade (internal use only) */
} TypesCubeComputerCommon3_PowerSelect;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_ImageTransferOpCode
*/
typedef enum TypesCubeComputerCommon3_ImageTransferOpCodeEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__CAPTURE_STORE = 0,       /**< Capture an image from the target node and store it on CubeComputer */
    TYPES_CUBE_COMPUTER_COMMON_3__CAPTURE_DOWNLOAD = 1,    /**< Capture an image from the target node and immediately download it without storing it on CubeComputer */
    TYPES_CUBE_COMPUTER_COMMON_3__DOWNLOAD = 2,            /**< Download an image stored on CubeComputer */
    TYPES_CUBE_COMPUTER_COMMON_3__INFO_RESET = 3,          /**< Reset the file info request to start from the first image file */
} TypesCubeComputerCommon3_ImageTransferOpCode;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_ImageTransferState
*/
typedef enum TypesCubeComputerCommon3_ImageTransferStateEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__STATE_IDLE = 0,             /**< Idle */
    TYPES_CUBE_COMPUTER_COMMON_3__STATE_BUSY_STORE = 1,       /**< Node image is being sttored internally on CubeComputer */
    TYPES_CUBE_COMPUTER_COMMON_3__STATE_BUSY_DOWNLOAD = 2,    /**< Node image is being downloaded from CubeComputer. This state applies to both direct downloads and downloads from storage */
} TypesCubeComputerCommon3_ImageTransferState;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_EventReadQueueState
*/
typedef enum TypesCubeComputerCommon3_EventReadQueueStateEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__EVT_READ_QIDLE = 0,        /**< Idle */
    TYPES_CUBE_COMPUTER_COMMON_3__EVT_READ_QDOWNLOAD = 1,    /**< Event log download in progress */
    TYPES_CUBE_COMPUTER_COMMON_3__EVT_READ_QERASE = 2,       /**< Event log erase is progress */
} TypesCubeComputerCommon3_EventReadQueueState;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_TlmLogReadQueueState
*/
typedef enum TypesCubeComputerCommon3_TlmLogReadQueueStateEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__TLM_READ_QIDLE = 0,        /**< Idle */
    TYPES_CUBE_COMPUTER_COMMON_3__TLM_READ_QDOWNLOAD = 1,    /**< Telemetry log download in progress */
    TYPES_CUBE_COMPUTER_COMMON_3__TLM_READ_QERASE = 2,       /**< Telemetry log erase is progress */
} TypesCubeComputerCommon3_TlmLogReadQueueState;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_TlmLogReturnIntervalValues
*/
typedef enum TypesCubeComputerCommon3_TlmLogReturnIntervalValuesEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL_200MS = 0,    /**< Apply 200ms return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL1S = 1,        /**< Apply 1s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL2S = 2,        /**< Apply 2s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL3S = 3,        /**< Apply 3s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL4S = 4,        /**< Apply 4s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL5S = 5,        /**< Apply 5s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL_10S = 6,      /**< Apply 10s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL_20S = 7,      /**< Apply 20s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL_50S = 8,      /**< Apply 50s return interval */
    TYPES_CUBE_COMPUTER_COMMON_3__INTERVAL_100S = 9,     /**< Apply 100s return interval */
} TypesCubeComputerCommon3_TlmLogReturnIntervalValues;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_EraseMagicNumbers
*/
typedef enum TypesCubeComputerCommon3_EraseMagicNumbersEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__ERASE_TLM_LOG = 57,       /**< Erase the Telemetry log */
    TYPES_CUBE_COMPUTER_COMMON_3__ERASE_EVENT_LOG = 117,    /**< Erase the Event log */
    TYPES_CUBE_COMPUTER_COMMON_3__ERASE_IMAGE_LOG = 195,    /**< Erase the Image log */
} TypesCubeComputerCommon3_EraseMagicNumbers;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_EventClass
*/
typedef enum TypesCubeComputerCommon3_EventClassEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__EVENT_CLASS_INFO = 0,             /**< Event class info */
    TYPES_CUBE_COMPUTER_COMMON_3__EVENT_CLASS_WARNING_MINOR = 1,    /**< Event class warning minor */
    TYPES_CUBE_COMPUTER_COMMON_3__EVENT_CLASS_WARNING_MAJOR = 2,    /**< Event class warning major */
    TYPES_CUBE_COMPUTER_COMMON_3__EVENT_CLASS_CRITICAL = 3,         /**< Event class critical */
} TypesCubeComputerCommon3_EventClass;

/**
 * @brief Enumeration for TypesCubeComputerCommon3_LogReadFilterType
*/
typedef enum TypesCubeComputerCommon3_LogReadFilterTypeEnum {
    TYPES_CUBE_COMPUTER_COMMON_3__FILTER_NONE = 0,              /**< Include all entries */
    TYPES_CUBE_COMPUTER_COMMON_3__FILTER_TIME_SPAN = 1,         /**< Filter/read entries logged between two timestamps */
    TYPES_CUBE_COMPUTER_COMMON_3__FILTER_TIME_NEXT_X = 2,       /**< Filter/read the next x entries logged following the sepecifed start timestamp */
    TYPES_CUBE_COMPUTER_COMMON_3__FILTER_FIRST_X = 3,           /**< Filter/read the first x entries logged */
    TYPES_CUBE_COMPUTER_COMMON_3__FILTER_LAST_X = 4,            /**< Filter/read the last x entries logged */
    TYPES_CUBE_COMPUTER_COMMON_3__FILTER_COUNTER_NEXT_X = 5,    /**< Filter/read the next x entries logged following the specified write counter */
} TypesCubeComputerCommon3_LogReadFilterType;

/**
 * @brief Power state message structure
 * @details Power state
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_PowerStateStruct {
    TypesCubeComputerCommon3_PowerSelect rwl0Power;          /**< RWL0 power state  */
    TypesCubeComputerCommon3_PowerSelect rwl1Power;          /**< RWL1 power state  */
    TypesCubeComputerCommon3_PowerSelect rwl2Power;          /**< RWL2 power state  */
    TypesCubeComputerCommon3_PowerSelect rwl3Power;          /**< RWL3 power state  */
    TypesCubeComputerCommon3_PowerSelect mag0Power;          /**< MAG0 power state  */
    TypesCubeComputerCommon3_PowerSelect mag1Power;          /**< MAG1 power state  */
    TypesCubeComputerCommon3_PowerSelect gyro0Power;         /**< GYR0 power state  */
    TypesCubeComputerCommon3_PowerSelect gyro1Power;         /**< GYR1 power state  */
    TypesCubeComputerCommon3_PowerSelect fss0Power;          /**< FSS0 power state  */
    TypesCubeComputerCommon3_PowerSelect fss1Power;          /**< FSS1 power state  */
    TypesCubeComputerCommon3_PowerSelect fss2Power;          /**< FSS2 power state  */
    TypesCubeComputerCommon3_PowerSelect fss3Power;          /**< FSS3 power state  */
    TypesCubeComputerCommon3_PowerSelect hss0Power;          /**< HSS0 power state  */
    TypesCubeComputerCommon3_PowerSelect hss1Power;          /**< HSS1 power state  */
    TypesCubeComputerCommon3_PowerSelect str0Power;          /**< STR0 power state  */
    TypesCubeComputerCommon3_PowerSelect str1Power;          /**< STR1 power state  */
    TypesCubeComputerCommon3_PowerSelect extSensor0Power;    /**< ExtSensor0 power state  */
    TypesCubeComputerCommon3_PowerSelect extSensor1Power;    /**< ExtSensor1 power state  */
    TypesCubeComputerCommon3_PowerSelect extGyro0Power;      /**< EXTGYR0 power state  */
    TypesCubeComputerCommon3_PowerSelect extGyro1Power;      /**< EXTGYR1 power state  */
} TypesCubeComputerCommon3_PowerState;

/**
 * @brief Pass Through  message structure
 * @details TCTLM Passthrough settings
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_PassThroughStruct {
    TypesCommonFrameworkTypes1_AbstractNode targetNode;    /**< Target Node  */
} TypesCubeComputerCommon3_PassThrough;

/**
 * @brief Port Diagnostics message structure
 * @details Diagnostics relating to the inernal CubeConnect interface port
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_PortDiagnosticsStruct {
...
} TypesCubeComputerCommon3_PortDiagnostics;
 ...
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_PortMapStruct {
    TypesCommonFrameworkTypes1_NodeType sensor1NodeType;            /**< Sensor 1 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor1AbstractType;    /**< Sensor 1 port - Abstract Node type identifier  */
    U32 sensor1SerialInt;                                           /**< Sensor 1 port - Serial Number Integer Respresentation  */
    U32 sensor1Address;                                             /**< Sensor 1 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor2NodeType;            /**< Sensor 2 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor2AbstractType;    /**< Sensor 2 port - Abstract Node type identifier  */
    U32 sensor2SerialInt;                                           /**< Sensor 2 port - Serial Number Integer Respresentation  */
    U32 sensor2Address;                                             /**< Sensor 2 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor3NodeType;            /**< Sensor 3 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor3AbstractType;    /**< Sensor 3 port - Abstract Node type identifier  */
    U32 sensor3SerialInt;                                           /**< Sensor 3 port - Serial Number Integer Respresentation  */
    U32 sensor3Address;                                             /**< Sensor 3 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor4NodeType;            /**< Sensor 4 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor4AbstractType;    /**< Sensor 4 port - Abstract Node type identifier  */
    U32 sensor4SerialInt;                                           /**< Sensor 4 port - Serial Number Integer Respresentation  */
    U32 sensor4Address;                                             /**< Sensor 4 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor5NodeType;            /**< Sensor 5 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor5AbstractType;    /**< Sensor 5 port - Abstract Node type identifier  */
    U32 sensor5SerialInt;                                           /**< Sensor 5 port - Serial Number Integer Respresentation  */
    U32 sensor5Address;                                             /**< Sensor 5 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor6NodeType;            /**< Sensor 6 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor6AbstractType;    /**< Sensor 6 port - Abstract Node type identifier  */
    U32 sensor6SerialInt;                                           /**< Sensor 6 port - Serial Number Integer Respresentation  */
    U32 sensor6Address;                                             /**< Sensor 6 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor7NodeType;            /**< Sensor 7 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor7AbstractType;    /**< Sensor 7 port - Abstract Node type identifier  */
    U32 sensor7SerialInt;                                           /**< Sensor 7 port - Serial Number Integer Respresentation  */
    U32 sensor7Address;                                             /**< Sensor 7 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType sensor8NodeType;            /**< Sensor 8 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode sensor8AbstractType;    /**< Sensor 8 port - Abstract Node type identifier  */
    U32 sensor8SerialInt;                                           /**< Sensor 8 port - Serial Number Integer Respresentation  */
    U32 sensor8Address;                                             /**< Sensor 8 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType wheel1NodeType;             /**< Wheel 1 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode wheel1AbstractType;     /**< Wheel 1 port - Abstract Node type identifier  */
    U32 wheel1SerialInt;                                            /**< Wheel 1 port - Serial Number Integer Respresentation  */
    U32 wheel1Address;                                              /**< Wheel 1 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType wheel2NodeType;             /**< Wheel 2 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode wheel2AbstractType;     /**< Wheel 2 port - Abstract Node type identifier  */
    U32 wheel2SerialInt;                                            /**< Wheel 2 port - Serial Number Integer Respresentation  */
    U32 wheel2Address;                                              /**< Wheel 2 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType wheel3NodeType;             /**< Wheel 3 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode wheel3AbstractType;     /**< Wheel 3 port - Abstract Node type identifier  */
    U32 wheel3SerialInt;                                            /**< Wheel 3 port - Serial Number Integer Respresentation  */
    U32 wheel3Address;                                              /**< Wheel 3 port - CAN Address  */
    TypesCommonFrameworkTypes1_NodeType wheel4NodeType;             /**< Wheel 4 port - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode wheel4AbstractType;     /**< Wheel 4 port - Abstract Node type identifier  */
    U32 wheel4SerialInt;                                            /**< Wheel 4 port - Serial Number Integer Respresentation  */
    U32 wheel4Address;                                              /**< Wheel 4 port - CAN Address  */
} TypesCubeComputerCommon3_PortMap;

/**
 * @brief Expected Nodes message structure
 * @details Lists the expected nodes config item
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_ExpectedNodesStruct {
    TypesCommonFrameworkTypes1_NodeType expected0NodeType;             /**< Slot 0 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected0AbstractType;     /**< Slot 0 - Abstract Node type identifier  */
    U32 expected0SerialInt;                                            /**< Slot 0 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected1NodeType;             /**< Slot 1 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected1AbstractType;     /**< Slot 1 - Abstract Node type identifier  */
    U32 expected1SerialInt;                                            /**< Slot 1 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected2NodeType;             /**< Slot 2 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected2AbstractType;     /**< Slot 2 - Abstract Node type identifier  */
    U32 expected2SerialInt;                                            /**< Slot 2 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected3NodeType;             /**< Slot 3 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected3AbstractType;     /**< Slot 3 - Abstract Node type identifier  */
    U32 expected3SerialInt;                                            /**< Slot 3 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected4NodeType;             /**< Slot 4 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected4AbstractType;     /**< Slot 4 - Abstract Node type identifier  */
    U32 expected4SerialInt;                                            /**< Slot 4 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected5NodeType;             /**< Slot 5 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected5AbstractType;     /**< Slot 5 - Abstract Node type identifier  */
    U32 expected5SerialInt;                                            /**< Slot 5 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected6NodeType;             /**< Slot 6 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected6AbstractType;     /**< Slot 6 - Abstract Node type identifier  */
    U32 expected6SerialInt;                                            /**< Slot 6 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected7NodeType;             /**< Slot 7 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected7AbstractType;     /**< Slot 7 - Abstract Node type identifier  */
    U32 expected7SerialInt;                                            /**< Slot 7 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected8NodeType;             /**< Slot 8 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected8AbstractType;     /**< Slot 8 - Abstract Node type identifier  */
    U32 expected8SerialInt;                                            /**< Slot 8 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected9NodeType;             /**< Slot 9 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected9AbstractType;     /**< Slot 9 - Abstract Node type identifier  */
    U32 expected9SerialInt;                                            /**< Slot 9 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected10NodeType;            /**< Slot 10 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected10AbstractType;    /**< Slot 10 - Abstract Node type identifier  */
    U32 expected10SerialInt;                                           /**< Slot 10 - Serial Number Integer Respresentation  */
    TypesCommonFrameworkTypes1_NodeType expected11NodeType;            /**< Slot 11 - Node type identifier  */
    TypesCommonFrameworkTypes1_AbstractNode expected11AbstractType;    /**< Slot 11 - Abstract Node type identifier  */
    U32 expected11SerialInt;                                           /**< Slot 11 - Serial Number Integer Respresentation  */
} TypesCubeComputerCommon3_ExpectedNodes;

/**
 * @brief Format all logs message structure
 * @details Format all logs
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_EraseLogDataStruct {
    TypesCubeComputerCommon3_EraseMagicNumbers magicNumber;    /**< Magic number to avoid erroneous formats  */
} TypesCubeComputerCommon3_EraseLogData;

/**
 * @brief Get the Event log status response message structure
 * @details Get the Event log status response
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_EventLogStatusStruct {
    ...
    TypesCubeComputerCommon3_EventReadQueueState readQueueState;    /**< The state of the read queue  */
} TypesCubeComputerCommon3_EventLogStatus;

/**
 * @brief Get the Telemtry log status response message structure
 * @details Get the Telemtry log status response
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_TelemtryLogStatusStruct {
    ...
    U32 latestEntryUnix;                                             /**< Timestamp of the latest entry unix time in seconds  */
    U32 writeCounter;                                                /**< The current event write counter  */
    TypesCubeComputerCommon3_TlmLogReadQueueState readQueueState;    /**< The state of the read queue  */
} TypesCubeComputerCommon3_TelemtryLogStatus;

/**
 * @brief Telemtry log inclusion masks message structure
 * @details Get the Telemtry log inclusion masks
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_TelemtryLogInclusionMasksStruct {
...
} TypesCubeComputerCommon3_TelemtryLogInclusionMasks;
 ...
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_EventLogFilterTransferSetupStruct {
    TypesCubeComputerCommon3_LogReadFilterType filterType;    /**< Filter type to use when reading event logs  */
...
} TypesCubeComputerCommon3_EventLogFilterTransferSetup;

/**
 * @brief Set request telemetry log transfer setup message structure
 * @details Set request telemetry log transfer setup
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_TelemetryLogTransferSetupStruct {
    TypesCubeComputerCommon3_LogReadFilterType filterType;                       /**< Filter type to use when reading tlm logs  */
    ...
    U32 numEntries;                                                              /**< If using time next-x or first/last-x or counter next-x filter - indicate the number of entries to transfer.  */
    U32 writeCounter;                                                            /**< If using counter next-x filter - indicate the reference write counter value.  */
    TypesCubeComputerCommon3_TlmLogReturnIntervalValues tlmLogReturnInterval;    /**< Indicate how many samples to exclude between transferred samples  */
    U8 logIdBitmask[5];                                                          /**< Indicate which log IDs must be included in the transfered Telemetry Log  */
} TypesCubeComputerCommon3_TelemetryLogTransferSetup;

/**
 * @brief Unsolicited Event Message Setup message structure
 * @details Setup unsolicited event messages
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_UnsolicitedEventSetupStruct {
...
} TypesCubeComputerCommon3_UnsolicitedEventSetup;

/**
 * @brief Unsolicited Telemetry Message Setup message structure
 * @details Inclusion bitmask for unsolicited telemetry
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_UnsolicitedTlmSetupStruct {
    TypesCubeComputerCommon3_TlmLogReturnIntervalValues uartTlmInterval;     /**< Indicate how frequently unsolicited telemetry is transmitted on the UART interface  */
    TypesCubeComputerCommon3_TlmLogReturnIntervalValues uart2TlmInterval;    /**< Indicate how frequently unsolicited telemetry is transmitted on the UART2 interface  */
    TypesCubeComputerCommon3_TlmLogReturnIntervalValues canTlmInterval;      /**< Indicate how frequently unsolicited telemetry is transmitted on the CAN interface  */
...
} TypesCubeComputerCommon3_UnsolicitedTlmSetup;

/**
 * @brief Set a dummy event message structure
 * @details Set a dummy event to be stored in the event log
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_DummyEventStruct {
    TypesCubeComputerCommon3_EventClass eventClass;         /**< This field contains the class of the event  */
    TypesCommonFrameworkTypes1_AbstractNode eventSource;    /**< This field contains the source of the event  */
    U16 eventType;                                          /**< This field contains the type of the event  */
    U8 eventData[8];                                        /**< This field contains the data of the event  */
} TypesCubeComputerCommon3_DummyEvent;

/**
 * @brief Set request image log transfer setup message structure
 * @details Set request image log transfer setup
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_ImageTransferSetupStruct {
    TypesCubeComputerCommon3_ImageTransferOpCode opCode;    /**< Operation code.  */
    TypesCommonFrameworkTypes1_AbstractNode nodeType;       /**< Target node type for image storage and download direct operation codes.  */
    U32 fileHandle;                                         /**< Target file for download and info operation codes.  */
} TypesCubeComputerCommon3_ImageTransferSetup;

/**
 * @brief Image Transfer Status message structure
 * @details Image Transfer Status
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_ImageTransferStatusStruct {
    TypesCubeComputerCommon3_ImageTransferState state;    /**< State  */
...
} TypesCubeComputerCommon3_ImageTransferStatus;

/**
 * @brief Image File Info message structure
 * @details Stored image file information
 */
typedef struct TCTLM_PACKED TypesCubeComputerCommon3_ImageFileInfoStruct {
    U32 fileHandle;                                      /**< File handle of this file.  */
    TypesCommonFrameworkTypes1_AbstractNode nodeType;    /**< The node that this file was sourced from.  */
...
} TypesCubeComputerCommon3_ComponentErrorCodes;
...
#endif // TYPES_CUBE_COMPUTER_COMMON_3_H
