...
ErrorCode tctlmCubeSenseCommon1_setCamAutoAdjust(TypeDef_TctlmEndpoint *endpoint, TypesCubeSenseCommon1_CamAutoAdjust *setVal)
{
    ...
    if (result == CUBEOBC_ERROR_OK)
    {
        U8 prepare0 = ((setVal->enabled & 0x01) << 0);
...
ErrorCode tctlmCubeSenseCommon1_getHealthTlm(TypeDef_TctlmEndpoint *endpoint, TypesCubeSenseCommon1_HealthTlm *returnVal)
{
    ...
    if (result == CUBEOBC_ERROR_OK)
    {
        ...
        returnVal->overcurrentCam = (TypesCubeSenseCommon1_OvercurrentResult)((prepare7 >> 0) & 0xFF);
    }
    /*************************/
    if (result == CUBEOBC_ERROR_OK)
    {
        ...
        returnVal->overcurrentSram = (TypesCubeSenseCommon1_OvercurrentResult)((prepare8 >> 0) & 0xFF);
    }
    /*************************/
    if (result == CUBEOBC_ERROR_OK)
    {
