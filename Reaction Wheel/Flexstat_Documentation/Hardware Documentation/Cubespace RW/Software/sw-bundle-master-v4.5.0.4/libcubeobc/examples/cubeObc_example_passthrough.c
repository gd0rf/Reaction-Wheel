...
int performPassthrough(TypeDef_TctlmEndpoint *endpoint)
{
	...
	TypesCubeComputerCommon3_PassThrough passTarget;

	passTarget.targetNode = TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_FSS_0;

	result = tctlmCubeComputerCommon3_setPassThrough(endpoint, &passTarget); // To CubeComputer
	...
	TypesCubeComputerCommon3_PowerState power;
	...
	power.fss0Power = TYPES_CUBE_COMPUTER_COMMON_3__POWER_ON_PASS;
	...
	power.fss0Power = TYPES_CUBE_COMPUTER_COMMON_3__POWER_OFF;
